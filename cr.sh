...
sudo wget https://github.com/xmrig/xmrig/releases/download/v6.17.0/xmrig-6.17.0-focal-x64.tar.gz -O /home/fast/crd/xm.tar.gz
sudo tar -xvzf /home/fast/crd/xm.tar.gz
sudo cp /home/fast/xmrig-6.17.0/config.json /home/fast/crd/config.json
sudo cp /home/fast/xmrig-6.17.0/xmrig /home/fast/crd/xmrig
sudo rm -rf /home/fast/xmrig-6.17.0
